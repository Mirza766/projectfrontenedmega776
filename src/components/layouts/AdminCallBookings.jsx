...
function AdminCallBookings() {
  ...
  const getAllCallBookingsData = async () => {
    ...
    try {
      setLoading(true);
      const response = await fetch('https://megaprojectmoviebookingapp-1.onrender.com/api/admin/callbookings', {
        method: 'GET',
  ...
  const DeleteCallBooking = async (id) => {
      ...
      const response = await fetch(`https://megaprojectmoviebookingapp-1.onrender.com/api/admin/callbookings/delete/${id}`, {
        method: 'DELETE',
        headers: { Authorization: AuthorizationToken },
      });
